"""Tests for the MCP interface. Same approach as the other two projects'
test_mcp_server.py - see those for why build_mcp_server() needs the
...
async def test_call_without_payment_returns_correct_402_body():
    ...
    assert quote["amount"] == "3000"  # $0.003 at 6 decimals
