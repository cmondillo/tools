"""Core product logic: fetch a URL and extract clean preview metadata.

Kept deliberately independent of FastAPI/x402 so it can be unit-tested and
reused on its own. The only thing this module cares about is: given a URL,
return {title, description, image, favicon, ...} safely.
...
_MAX_REDIRECTS = 5
_USER_AGENT = (
    "LinkPreviewBot/1.0 (+https://github.com/cmondillo/tools; "
